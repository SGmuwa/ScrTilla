...
namespace ScrTilla
{
    ...
    static class PrtScr_Hook
    {
        ...
        /// </summary>
        /// <param name="act">Метод, который должен вызываться при нажатии клавиши Print Screen</param>
        ...
        /// </summary>
        /// <param name="act">Метод, который вызывался при нажатии клавиши Print Screen</param>
